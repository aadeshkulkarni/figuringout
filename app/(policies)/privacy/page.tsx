...
const page = () => {
  return (
    <Card>
      <CardTitle className="text-2xl font-bold mb-2 border-b p-4">Privacy Policy</CardTitle>
      <CardContent className="p-4">
        ...
        <h2 className="text-xl py-2 font-bold">Interpretation and Definitions</h2>
        <h3 className="text-lg py-2 font-bold">Interpretation</h3>
        <p>
          The words of which the initial letter is capitalized have meanings defined under the
          following conditions. The following definitions shall have the same meaning regardless of
          whether they appear in singular or in plural.
        </p>
        <h3 className="text-lg py-2 font-bold">Definitions</h3>
        ...
        <ul>
          ...
          <li>
            <p>
              <strong>Application</strong> refers to Figuringout.digital, the software program provided
              by the Company.
            </p>
          </li>
          <li>
        ...
        <h2 className="text-2xl py-2 font-bold">Collecting and Using Your Personal Data</h2>
        <h3 className="text-xl py-2 font-bold">Types of Data Collected</h3>
        <h4 className="text-lg py-2 font-bold">Personal Data</h4>
        <p>
        ...
        <h4 className="text-md py-2 font-bold">Usage Data</h4>
        ...
        <h3 className="text-xl py-2 font-bold">Use of Your Personal Data</h3>
        ...
        <h3 className="text-xl py-2 font-bold">Retention of Your Personal Data</h3>
        <p>
        ...
        <h3 className="text-xl py-2 font-bold">Transfer of Your Personal Data</h3>
        <p>
        ...
        <h3 className="text-xl py-2 font-bold">Delete Your Personal Data</h3>
        <p>
        ...
        <h3 className="text-xl py-2 font-bold">Disclosure of Your Personal Data</h3>
        <h4 className="text-lg py-2 font-bold">Business Transactions</h4>
        <p>
        ...
        <h4 className="text-lg py-2 font-bold">Law enforcement</h4>
        <p>
          Under certain circumstances, the Company may be required to disclose Your Personal Data if
          required to do so by law or in response to valid requests by public authorities (e.g. a
          court or a government agency).
        </p>
        <h4 className="text-lg py-2 font-bold">Other legal requirements</h4>
        <p>
        ...
        <h3 className="text-xl py-2 font-bold">Security of Your Personal Data</h3>
        <p>
        ...
        <h2 className="text-2xl py-2 font-bold">Children's Privacy</h2>
        <p>
        ...
        <h2 className="text-2xl py-2 font-bold">Links to Other Websites</h2>
        <p>
        ...
        <h2 className="text-2xl py-2 font-bold">Changes to this Privacy Policy</h2>
        <p>
        ...
        <h2 className="text-2xl py-2 font-bold">Contact Us</h2>
        <p>If you have any questions about this Privacy Policy, You can contact us:</p>
        <ul>
          <li>By email: customersupport@Figuringout.digital</li>
        </ul>
      </CardContent>
    </Card>
  );
